...
abstract class AppLocalizations {
  ...
  /// No description provided for @errGoogleSignIn12500.
  ///
  /// In zh, this message translates to:
  ...
  /// No description provided for @errMicrosoftPersonalAccountNotSupported.
  ///
  /// In zh, this message translates to:
